...
namespace Shay {
    class TexturedPolygons {
      ...
      private:
        ...
        void CreateXtoZTextureList(const GLfloat &xImgSize,
                                   const GLfloat &zImgSize, const GLfloat &xStart,
                                   const GLfloat &yStart, const GLfloat &zStart,
                                   const GLfloat &xTimes, const GLfloat &zTimes);
